        ...
        <>
            ...
            <section className="coaching w-full px-5 lg:px-10 mb-20 grid md:gap-5 md:grid-cols-2 lg:grid-cols-4">
                ...
                <section className="mb-5 md:mb-0 md:col-span-2 border-t-8 border-blue pt-5 px-5 bg-blue bg-opacity-5">
                    ...
                    <p className="text-sm mb-2"><Link href="/membership"><a>Under 12s membership</a></Link> is now an option at a discounted £5 for the year.</p>
                    ...
                    <section className="mb-5 grid md:grid-cols-2 md:gap-2">
                        <a href="https://www.britishcycling.org.uk/zuvvi/media/bc_files/go_ride_racing_docs/2018/Go_Ride_PARENTAL_CONSENT_NOTICE_2018_V3.pdf" className="bg-black bg-opacity-5 p-2.5 inline-flex flex-row items-center">
                            <Image src="/img/pdf.svg" width="75" height="75" alt="" />
                    ...
                    <p className="text-sm mb-5">We are proud to be a validated Learning Destination. Collect CU credits at our activities with your Passport to Learning. There is more on <a href="https://www.childrensuniversity.co.uk/universities/rotherham-childrens-university/">Rotherham Children's University</a> here.</p>
                    <h2 className="text-3xl font-ropa">The Coalfields Regeneration Trust</h2>
                    <p className="text-sm mb-5">The Coalfields Regeneration Trust has provided funding to train 3 British Cycling Level 1 coaches and progress 3 coaches to Level 2. More can be found on <a href="https://www.coalfields-regen.org.uk/">The Coalfields Regeneration Trust</a> here.</p>
                    ...
                    <p className="text-sm mb-5">We also have <Link href="/welfare"><a>Club Welfare Officers</a></Link> and follow British Cycling's Safeguarding policies.</p>
                </section>
