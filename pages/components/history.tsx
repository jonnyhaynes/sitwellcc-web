        ...
        <section className="flex flex-col md:grid md:grid-cols-9 mx-auto p-2 text-black">
            ...
            <div className="flex flex-row-reverse md:contents">
                ...
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    ...
                    <div className="w-6 h-6 absolute top-1/2 -mt-3 rounded-full bg-green"></div>
                </div>
            </div>
            {/* right */}
            <div className="flex md:contents">
                ...
                <div className="w-full bg-yellow bg-opacity-25 col-start-6 col-end-10 p-5 my-2.5 md:-my-5 mr-auto">
                    ...
                    <p className="text-sm">Most Improved: Robin Hartley</p>
                </div>
            </div>
            {/* left */}
            <div className="flex flex-row-reverse md:contents">
                <div className="w-full bg-green bg-opacity-25 col-start-1 col-end-5 p-5 my-2.5 md:-my-5 ml-auto md:text-right">
                    ...
                    <p className="text-sm">Most Improved: Kaz Tarry</p>
                    <p className="text-sm">GC: Stephen Bond</p>
                    <p className="text-sm">PC: Maz Iqbal</p>
                    <p className="text-sm">KOM: James Fox</p>
                </div>
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div className="h-full w-6 flex items-center justify-center">
                        <div className="h-full w-1 bg-black bg-opacity-25 pointer-events-none"></div>
            ...
            <div className="flex flex-row-reverse md:contents">
                <div className="w-full bg-green bg-opacity-25 col-start-1 col-end-5 p-5 my-2.5 md:-my-5 ml-auto md:text-right">
                    ...
                    <p className="text-sm">GC: Ted Daly</p>
                    <p className="text-sm">Most Improved: Jonny Haynes</p>
                </div>
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div className="h-full w-6 flex items-center justify-center">
                        <div className="h-full w-1 bg-black bg-opacity-25 pointer-events-none"></div>
            ...
            <div className="flex flex-row-reverse md:contents">
                <div className="w-full bg-green bg-opacity-25 col-start-1 col-end-5 p-5 my-2.5 md:-my-5 ml-auto md:text-right">
                    ...
                    <p className="text-sm">GC: Ben Daly</p>
                    <p className="text-sm">Most Improved: Abel Haynes</p>
                </div>
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div className="h-full w-6 flex items-center justify-center">
                        <div className="h-full w-1 bg-black bg-opacity-25 pointer-events-none"></div>
            ...
            <div className="flex flex-row-reverse md:contents">
                <div className="w-full bg-green bg-opacity-25 col-start-1 col-end-5 p-5 my-2.5 md:-my-5 ml-auto md:text-right">
                    ...
                    <p className="text-sm">GC: Joe Strike</p>
                    <p className="text-sm">KOM: Andy Laidler</p>
                    <p className="text-sm">Sprint: Nick Clayton</p>
                    <p className="text-sm">Most Improved: Arun Alfred</p>
                </div>
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div className="h-full w-6 flex items-center justify-center">
                        <div className="h-full w-1 bg-black bg-opacity-25 pointer-events-none"></div>
            ...
            <div className="flex flex-row-reverse md:contents">
                <div className="w-full bg-green bg-opacity-25 col-start-1 col-end-5 p-5 my-2.5 md:-my-5 ml-auto md:text-right">
                    ...
                    <p className="text-sm">GC: Rob Toplis</p>
                    <p className="text-sm">KOM: Andy Laidler</p>
                    <p className="text-sm">Sprint: Simon Law</p>
                </div>
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div className="h-full w-6 flex items-center justify-center">
                        <div className="h-full w-1 bg-black bg-opacity-25 pointer-events-none"></div>
            ...
            <div className="flex flex-row-reverse md:contents">
                <div className="w-full bg-green bg-opacity-25 col-start-1 col-end-5 p-5 my-2.5 md:-my-5 ml-auto md:text-right">
                    ...
                    <p className="text-sm">KOM: Andy Laidler</p>
                    <p className="text-sm">Sprint: Greg Trowman</p>
                </div>
                <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
                    <div className="h-full w-6 flex items-center justify-center">
                        <div className="h-full w-1 bg-black bg-opacity-25 pointer-events-none"></div>
