...
type RideColor = 'green' | 'amber' | 'red' | 'brown' | 'blue' | 'black';
...
const DATA = [
    {
        ...
        description: "If you're not comfortable riding on the outside, ask the rider on the inside to let you in (they slow, you go in front of them, the outside line moves up).  Getting comfortable riding tight together comes with practice. Riding in 2 tight lines is the Club's default group riding structure.",
    },
    {
        title: "2. Stay with your group, and make sure those behind can stay with you.",
        description: "Be aware of the riders behind you, they should be close (see above).  Ease-up if the rider behind you is struggling.  When riding up slight climbs, aim for consistent effort not consistent speed. <br><br>It's expected that the group will split on long climbs, so stop and regroup at the top (or shortly after).",
    },
    {
        title: "3. Ride at the pace of the rider beside you, if they slow, you slow.",
        description: "If you ride slightly in front of the rider beside you [known as half wheeling], they will speed up. Soon you'll be riding at 40mph and the group will be all over the road. If the rider besides is half wheeling you, tell them to ease-up.",
    },
    {
        title: "4. Ride directly behind the rider in front and you'll ensure everyone stays in a safe, tidy position.",
        description: "Riding in the middle [of the 2 riders in front] causes the rider on your outside to be pushed wider into the road, makes the group harder to pass and puts that rider in the wind.",
    },
    {
        ...
        description: "If you ride in the gutter, you're forcing everyone behind you to do the same.  Drain covers are slippery and often wide enough to get your wheel stuck in. You should be riding to the right of drain covers, about 2 to 3 feet of the road edge.",
    },
    {
        ...
        description: "Braking hard is particularly dangerous.  The concertina effect means riders further back have even less time to react.  No-one wants to do the whole ride on a high alert.  The smoother everyone is, the more relaxed everyone can be.",
    },
    {
        ...
        description: "Controlling the pace of the ride is down to the riders on the front.  If you pass them, they can no longer control the pace.  If you want to ride on the front or come past, ask the rider in front.  It's also rare that the roads are quiet or wide enough to make it safe to ride 3 abreast.",
    },
    {
        title: "8. Ride at an inclusive pace when riding on the front and the group will stay together.",
        description: "When you're on the front, you are responsible for the pace of the group.  If you ride too fast, the group will split.  Be aware of who is in the group and their abilities.  Ride at a pace all can keep up with.",
    },
    {
        title: "9. Pedal on downhills when riding on the front so everyone doesn't run into the back of you.",
        description: "Wind resistance is exponential, you're going faster when going downhill so are hitting more wind than on the flats and far more than those behind.  When you're on the front of the group, pedal on the downhills.  It will stop riders behind you from having to brake.",
    },
    {
        title: "10. Overlapping your front wheel with the rear wheel of the rider in front could cause you to crash.",
        description: "If the rider in front moves out, and your wheel is there, you'll touch wheels.  When someone clips your front wheel you lose the ability to turn and balance.  It's very likely you will come off, as will everyone behind you.",
    },
    {
        title: "11. Ride Captains are there to keep the group together and safe. ",
        description: "Follow the Ride Captain's instructions on directions, group structure, stopping places, warnings about dangerous roads and junctions, regroups and general riding. If the Ride Captain tells you to slow down, ride tighter, watch your front wheel, keep in, move out, go forward, etc… please listen.",
    },
    {
        title: "12. A driver's ability, vision, reactions and even car performance effect when it's safe to pass. ",
        description: "Do not wave a vehicle past the group, leave the driver to decide when it's appropriate. ",
    },
    {
        title: "13. Lining out sometimes makes sense, but leave it to the Ride Captain to decide to avoid confusion.",
        description: "Lining out can often cause the group to split, it's scary for less experienced riders and often does not make it easier for a car to pass.  If everyone is shouting conflicting directions, it gets very confusing.  Check with the Ride Captain before shouting.",
    },
    {
        ...
        description: "There are often cars behind; They usually pass safely and without incident. Shouting “car back” can cause panic.  Riders may take it to mean they should line out, slow down or move over.  You're better to shout “keep it tight” or “Dave… move in”; It's far more clear.",
    },
    {
        ...
        description: "Common calls are “Gravel”, “Hole”, “Move Out” or anything really. Try to make it clear what you mean and point to where it is.  When riding tight together, you're unlikely to see a dead animal in the road, especially at night. These gestures and shouts will make sure you avoid it.",
    },
    {
...
const Rides: NextPage<{ rides: Ride[] }> = ({ rides }) => {

    const jsonLd = rides.map((ride) => ({
        ...
        <>
            ...
            <section className="rides w-full px-5 lg:px-10 mb-20 grid gap-5 md:grid-cols-2 lg:grid-cols-4">
                <div>
                    ...
                    <Image className="block w-full" src="/img/green-rides.webp" alt="A photograph of club members sat around a table" width="285" height="285" />
                ...
                <div>
                    ...
                    <Image className="block w-full" src="/img/amber-rides.webp" alt="A photograph of members on a gavel track" width="285" height="285" />
                ...
                <div>
                    ...
                    <Image className="block w-full" src="/img/red-rides.webp" alt="A photograph of members in a peloton" width="285" height="285" />
                ...
                <div>
                    ...
                    <Image className="block w-full" src="/img/offroad-rides.webp" alt="A photograph of members on an MTB trail" width="285" height="285" />
            ...
            <section className="w-full px-5 lg:px-10 mb-20 grid lg:grid-cols-2 lg:gap-5">
                <section>
                    ...
                    { rides.map((ride) => {
                        ...
                        const formatted = new Date(ride.startTime)
                        ...
                        return (
                            <article className={`mb-5 border-t-8 border-${color} p-5 bg-${color} bg-opacity-25 flex flex-row`} key={ride.id}>
                                {ride.image ? (
                                    <a href={ride.url} className="block w-28 h-28 mr-5 overflow-hidden flex-shrink-0">
                                        <Image src={ride.image} className="object-cover w-full h-full" alt={ride.title} width="108" height="108" />
                                    </a>
                                ) : (
                                    <a href={ride.url} aria-label={ride.title} className={`block w-28 h-28 mr-5 flex-shrink-0 bg-${color} bg-opacity-25`}></a>
                                )}
                                <div className="flex flex-col flex-grow justify-between">
                                    <div className="w-full">
                                        <time dateTime={ride.startTime} className="uppercase text-sm w-full self-start">{formatted}</time>
                                        <h4 className="text-2xl font-ropa leading-none w-full self-start"><a href={ride.url} className={`text-${color}`}>{ride.title}</a></h4>
                                    </div>
                                    <div className="flex flex-row items-center w-full">
                                        <a href={ride.url} className="btn self-start">View event</a>
                                        {ride.goingCount !== null && (
                                            <p className="text-sm ml-5">{ride.goingCount}{' '}{ride.goingCount === 1 ? 'rider' : 'riders'}{' '}going</p>
                                        )}
                                    </div>
                                </div>
                            </article>
...
function currentWeekBounds(): { startMs: number; endMs: number } {
    ...
    // London wall-clock parts for today.
    const parts = new Intl.DateTimeFormat('en-GB', {
        timeZone: 'Europe/London',
        year: 'numeric',
        month: '2-digit',
    ...
    // Midnight at the start of today, as a London wall-clock instant treated as UTC.
    const midnightTodayWall = Date.UTC(Number(get('year')), Number(get('month')) - 1, Number(get('day')));
    const mondayWall = midnightTodayWall - dayIndex * dayMs;

    // Convert London wall-clock to a true UTC instant by removing the offset.
...
export async function getServerSideProps({ res: response }: { res: { setHeader: (key: string, value: string) => void } }) {
    response.setHeader('Cache-Control', 'public, s-maxage=60, stale-while-revalidate=599');
