        ...
        <>
            ...
            <section className="w-full px-5 lg:px-10 mb-20 grid lg:grid-cols-3 lg:gap-5">
                ...
                <section className="lg:col-span-2">
                    ...
                    <p className="mb-2">If you have any concerns about the welfare of children or adults at risk involved in the Club you can contact our Welfare Officers by emailing: <a href="mailto:welfare@sitwell.cc">welfare@sitwell.cc</a></p>
                    ...
                    <section className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 pt-5 mb-5">
                        <article>
                            ...
                            <a href="mailto:craig.wright@sitwell.cc" className="btn">Contact Craig</a>
                        </article>
                        {/* <article>
                            ...
                            <p className="text-sm"><a href="https://www.nspcc.org.uk/what-you-can-do/get-expert-training/child-protection-sport-online-course/">Child Protection in Sport Certified</a></p>
                            <p className="text-sm mb-2.5"><a href="https://www.dbscheck.org/">DBS Checked</a></p>
                            <a href="mailto:claire.wardle@sitwell.cc" className="btn">Contact Claire</a>
                        </article> */}
                    </section>
                    <p><strong>British Cycling&apos;s Safeguarding Liaison Officer:</strong> <a href="tel:01612742000">0161 274 2000</a>.</p>
                    <p><strong>Rotherham Safeguarding Children Partnership:</strong> <a href="http://www.rscp.org.uk/">www.rscp.org.uk</a>.</p>
                    <p><strong>South Yorkshire Police:</strong> <a href="https://southyorks.police.uk/">southyorks.police.uk</a>.</p>
                    <p><strong>NSPCC:</strong> <a href="tel:08088005000">0808 800 5000</a>.</p>
                    <p className="mb-2"><strong>Childline:</strong> <a href="tel:08001111">0800 1111</a> or <a href="https://www.childline.org.uk">www.childline.org.uk</a>.</p>
                ...
                <section className="lg:col-span-2">
                    ...
                    <p><strong>Kidscape:</strong> <a href="https://www.kidscape.org.uk">www.kidscape.org.uk</a>.</p>
                    <p><strong>Anti-Bullying Alliance:</strong> <a href="https://www.anti-bullyingalliance.org.uk">www.anti-bullyingalliance.org.uk</a>.</p>
                </section>
                <section>
                ...
                <section className="lg:col-span-2">
                    ...
                    <p className="mb-2">On becoming a member of the Sitwell Cycling Club you will be invited to join our Slack Members&apos; Workspace. This forum provides an excellent opportunity for the Club and its members to promote and keep up-to-date with club events and activities; to celebrate achievements; to share knowledge and seek advice on all things cycling; debate a host of cycling issues; and, to generally catch-up and have a banter with fellow members. All members are required to adhere to the Club&apos;s Social Media Policy. </p>
                    <section className="mb-2 grid md:grid-cols-2 md:gap-2">
                    ...
                    <p>The Club is compliant with <a href="https://www.britishcycling.org.uk/zuvvi/media/bc_files/safeguarding/SG_5.2_Using_Social_Networking_Services_and_Social_Media.pdf">British Cycling&apos;s Safeguarding using Social Networking and Social Media guidelines</a>.</p>
                </section>
    </section>
        </>
    );
